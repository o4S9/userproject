...
urlpatterns = [
    ...
    path('user', views.userView, name='UserView'),
    path('ss', login_required(views.differencSS, login_url='/login')),
    path('stockdata', login_required(views.short, login_url='/login')),
    path('masterdata', login_required(views.excess, login_url='/login')),
    path('scand', login_required(views.downloadScan, login_url='/login')),

    path('scan/', views.upload_scanning, name="ScanningFile"),
    # path('dataEnter', views.update_barcode, name='update_barcode'),
    # path('dataEnter', views.delete_barcode, name='delete_barcode'),
    # path('upload/', views.deleteStockFile, name="DeleteStockFile"),
